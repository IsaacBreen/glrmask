...
def run_determinize_unweighted_pass(args):
    ...
    try:
        ...
        fst = fst.determinize(config=DeterminizeConfig(det_type=DeterminizeType.DETERMINIZE_FUNCTIONAL))
        print_fst_stats(fst, "After first determinizing")
        fst = fst.minimize()
        print_fst_stats(fst, "After first minimizing")
        fst = fst.determinize(config=DeterminizeConfig(det_type=DeterminizeType.DETERMINIZE_FUNCTIONAL))
        print_fst_stats(fst, "After second determinizing")
        fst = fst.minimize()
        print_fst_stats(fst, "After second minimizing")
