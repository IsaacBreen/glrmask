...
/// contiguous array chunk that fits in direct-partition cache.
struct Dfa {
    start_state: usize,
    num_states: usize,
...
/// in finalizers and possible_future_groups. This is used for pair-partition-only
/// equivalence analysis where direct-partition terminal groups are excluded.
///
...
/// direct-partition terminal groups can be excluded this way for a pair-partition-only analysis.
