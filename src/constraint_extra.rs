...
/// Helper function to recursively dump the structure of a PrecomputeNode Trie2.
...
impl GrammarConstraint { // This is in constraint_extra.rs
    /// Dumps the structure of the precomputed Trie2 map for visualization.
    ...
    pub fn _dump_precomputed(
        ...
        println!("Dumping Precomputed Trie2 1 Structure (showing original LLM Token IDs):");
        println!("===================================");
    ...
    /// Dumps the structure of the precomputed Trie2 2 map for visualization.
    ...
    pub fn _dump_precomputed2(precomputed2: &BTreeMap<TokenizerStateID, Arc<RwLock<PrecomputeNode2>>>, original_to_internal_id_bimap: &BiBTreeMap<usize, usize>, llm_token_map: &BiBTreeMap<Vec<u8>, LLMTokenID>) {
        println!("Dumping Precomputed Trie2 2 Structure (showing original LLM Token IDs):");
        println!("===================================");
