...
pub fn eliminate_pushes_and_pops_path_based(
    ...
    let all_paths =
        IntermediatePrecomputeNode3::get_all_paths_with_cycles(god, &all_root_indices, |_idx, n| n.value.end, 10);
...
pub(crate) fn get_normalized_paths_for_vec(
    ...
    IntermediatePrecomputeNode3::get_all_paths_with_cycles(god, &roots, |_idx, n| n.value.end, 10)
        .into_iter()
...
mod tests {
    ...
    fn run_test(
        ...
        let initial_paths =
            IntermediatePrecomputeNode3::get_all_paths_with_cycles(input_god, input_roots, |_idx, node| node.value.end, 10);
