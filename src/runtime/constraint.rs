...
impl Constraint {
    ...
    pub(crate) fn rebuild_runtime_caches_impl(&mut self) {
        ...
        let (
            ...
            let prebuilt_weight_caches =
                self.compute_direct_sparse_weight_token_buf_masks(&weight_token_sets.final_sets);
    ...
    fn compute_tokenizer_fast_transitions(&self) -> FastTokenizerTransitions {
        ...
        if self.tokenizer.has_packed_runtime_transitions() {
