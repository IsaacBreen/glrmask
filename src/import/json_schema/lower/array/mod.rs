...
use super::super::schema::{ArraySchema, SchemaKind};
use super::super::diagnostics::ImportResult;
use super::{choice, lit, never, seq, Lowerer};
...
impl<'a> Lowerer<'a> {
    ...
    fn fixed_array_items(&mut self, items: &[super::super::schema::Schema]) -> ImportResult<GrammarExpr> {
        if items.is_empty() {
...
fn bounded_array_object_item_candidate(schema: &super::super::schema::Schema) -> bool {
    match &schema.kind {
