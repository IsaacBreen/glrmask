...
pub(crate) struct Lowerer<'a> {
    ...
    pub(crate) shared_property_string_value_rules: BTreeMap<(usize, Option<usize>, Option<String>, Option<String>), String>,
...
impl<'a> Lowerer<'a> {
    ...
    fn new(document: &'a SchemaDocument, config: JsonSchemaConfig) -> Self {
        ...
        let mut lowerer = Self {
            ...
            shared_property_string_value_rules: BTreeMap::new(),
