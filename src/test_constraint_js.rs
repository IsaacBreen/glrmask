...
fn test_js_constraint_with_gpt2_vocab() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let vocab = vec!["\n", "\n\n", " ", " !", " \"", " #", " $", " %", " &", " '", " (", " )", " *", " +", " ,", " -", " .", " /", " :", " ;", " <", " =", " >", " ?", " @", " [", " \\", " ]", " ^", " _", " `", " x", " {", " |", " }", " ~", "!", "!!", "!\"", "!'", "!)", "!,", "!.", "!/", "!:", "!?", "!]", "\"", "\"!", "\"\"", "\"'", "\"(", "\")", "\",", "\"-", "\".", "\":", "\";", "\">", "\"?", "\"[", "\"]", "\"}", "#", "##", "#$", "$", "$$", "$,", "$.", "${", "%", "%\"", "%%", "%)", "%,", "%-", "%.", "%:", "%;", "%]", "&", "&&", "'", "'\"", "''", "')", "',", "'-", "'.", "'/", "':", "';", "'>", "'?", "']", "(", "(\"", "($", "(&", "('", "((", "()", "(*", "(-", "([", "(\\", "(_", "({", ")", ")!", ")\"", ")'", ")(", "))", ")*", ")+", "),", ")-", ").", ")/", "):", ");", ")=", ")?", ")[", ")\\", ")]", "){", ")|", ")}", "*", "*)", "**", "*,", "*.", "*/", "*:", "+", "+(", "+)", "++", "+,", "+.", "+=", ",", ",\"", ",'", ",)", ",,", ",-", ",.", ",[", "-", "-\"", "-$", "-'", "-(", "-)", "-+", "-,", "--", "-.", "->", "-[", "-|", ".", ".\"", ".#", ".$", ".'", ".(", ".)", ".*", ".,", ".-", "..", "./", ".:", ".;", ".<", ".?", ".[", ".]", "._", ".}", "/", "/\"", "/#", "/$", "/(", "/)", "/*", "/+", "/,", "/-", "/.", "//", "/>", "/?", "/_", ":", ":\"", ":#", ":'", ":(", ":,", ":-", ":/", "::", ":[", ":\\", ":]", ":{", ";", ";\"", ";;", ";}", "<", "</", "<<", "<?", "=", "=\"", "=#", "=$", "='", "=(", "=-", "=/", "==", "=>", "=[", "=]", "={", "=~", ">", ">\"", ">(", ">)", ">,", ">.", ">:", "><", ">>", ">[", ">]", "?", "?!", "?\"", "?'", "?)", "?,", "?:", "??", "?]", "@", "@#", "@@", "[", "[\"", "['", "[/", "[[", "[]", "[_", "\\", "\\\"", "\\'", "\\)", "\\-", "\\.", "\\/", "\\<", "\\\\", "]", "]\"", "]'", "](", "])", "]+", "],", "]-", "].", "]:", "];", "]=", "][", "]]", "]}", "^", "^^", "^{", "_", "_(", "_-", "_.", "_>", "__", "_{", "`", "`,", "`.", "``", "x", "xx", "{", "{\"", "{\\", "{{", "|", "||", "}", "}\"", "})", "},", "}.", "}:", "};", "}\\", "}{", "}}", "~", "~~", "¡", "¢", "£", "¤", "¥", "¦", "§", "¨", "©", "ª", "«", "¬", "®", "¯", "°", "±", "²", "³", "´", "µ", "¶", "·", "¸", "¹", "º", "»", "¼", "½", "¾", "¿", "À", "Á", "Â", "Ã", "Ä", "Å", "Æ", "Ç", "È", "É", "Ê", "Ë", "Ì", "Í", "Î", "Ï", "Ð", "Ñ", "Ò", "Ó", "Ô", "Õ", "Ö", "×", "Ø", "Ù", "Ú", "Û", "Ü", "Ý", "Þ", "ß", "à", "á", "â", "ã", "ä", "å", "æ", "ç", "è", "é", "ê", "ë", "ì", "í", "î", "ï", "ð", "ñ", "ò", "ó", "ô", "õ", "ö", "÷", "ø", "ù", "ú", "û", "ü", "ý", "þ", "ÿ", "Ā", "ā", "Ă", "ă", "Ą", "Ć", "ć", "Ĉ", "ĉ", "ċ", "Č", "č", "Ď", "ď", "Đ", "đ", "Ē", "ē", "Ĕ", "ĕ", "Ė", "ė", "Ę", "ę", "Ě", "ě", "Ĝ", "ĝ", "Ğ", "ğ", "ġ", "Ģ", "ģ", "Ĥ", "ĥ", "Ħ", "ħ", "Ĩ", "ĩ", "Ī", "ī", "Ĭ", "ĭ", "Į", "į", "İ", "ı", "Ĳ", "ĳ", "Ĵ", "ĵ", "Ķ", "ķ", "ĸ", "Ĺ", "ĺ", "Ļ", "ļ", "Ľ", "ľ", "Ŀ", "ŀ", "Ł", "ł", "Ń"];
