...
#[derive(Debug)]
pub(crate) enum SingletonEpsilonClosures {
    Dense(Box<[Box<[u32]>]>),
...
impl SingletonEpsilonClosures {
    ...
    #[inline]
    pub(crate) fn get(&self, state: usize) -> Option<&[u32]> {
        match self {
    ...
    #[inline]
    pub(crate) fn iter(&self) -> SingletonEpsilonClosuresIter<'_> {
...
pub(crate) struct SingletonEpsilonClosuresIter<'a> {
