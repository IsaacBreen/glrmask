...
mod tests {
    ...
    type TestTrieMerge = Trie1<&'static str, Vec<i32>, String>;
    type TestNodeMerge = Arc<RwLock<TestTrieMerge>>;
    // Use simpler types for basic tests
    type TestTrieBasic = Trie1<&'static str, &'static str, i32>;
    type TestNodeBasic = Arc<RwLock<TestTrieBasic>>;

    // Use concrete types for EdgeInserter tests
    type TestTrieEI = Trie1<&'static str, HybridBitset, String>; // Use HybridBitset here
    ...
    fn test_multiple_children_same_edge_key() {
        ...
        let all = Trie1::all_nodes(&[root.clone()]);
    ...
    fn test_all_nodes_diamond() {
        ...
        let all_nodes = Trie1::all_nodes(&[root.clone()]);
    ...
    fn test_empty_trie() {
        ...
        let nodes = Trie1::all_nodes(&[root.clone()]);
    ...
    fn test_has_any_cycle() {
        ...
        assert!(!Trie1::has_any_cycle(root1.clone()));
        ...
        assert!(Trie1::has_any_cycle(root2.clone()));
        ...
        assert!(Trie1::has_any_cycle(root3.clone()));
        ...
        assert!(Trie1::has_any_cycle(root4.clone()));
        ...
        assert!(!Trie1::has_any_cycle(root5.clone()));
        // Checking from root6_in_cycle SHOULD find the cycle
        assert!(Trie1::has_any_cycle(root6_in_cycle.clone()));
    }
