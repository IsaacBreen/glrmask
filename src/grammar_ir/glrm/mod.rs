//! Parser for the GLRM named-grammar exchange format.
//!
//! The renderer for this format is `grammar_ir::render::glrm`; this module owns
//! lexical analysis and parsing back into named grammar IR.

pub use crate::grammar_ir::render::glrm::to_glrm;
