...
impl GrammarConstraint {
    ...
    pub(crate) fn setup_llm_token_mappings(
        ...
        crate::debug!(4, "Vocabulary analysis: {} tokens reduced to {} equivalence classes", num_original_tokens, num_classes);
    ...
    fn build_with_config(
        ...
        crate::debug!(5, "Building internal vocab prefix tree");
        ...
        crate::debug!(5, "Done building internal vocab prefix tree");

        // Unified fast pass for maps and matches
        crate::debug!(5, "Computing maps and possible_matches (fast parallel pass)");
        ...
        crate::debug!(5, "Computing terminal follow sets");
        ...
        crate::debug!(5, "Converting precompute1 Trie to NWA");
