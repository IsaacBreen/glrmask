...
fn create_simple_parser() -> GLRParser {
    ...
    generate_glr_parser(&productions, &HashSet::new(), None)
}
...
fn test_repetition_no_eof_1() {
    ...
    let parser = generate_glr_parser(&productions, &HashSet::new(), None);
...
fn test_repetition_no_eof_2() {
    ...
    let parser_with_b = generate_glr_parser(&productions_with_b, &HashSet::new(), None);
...
fn test_parser_stats_conflicts() {
    ...
    let rr_parser = generate_glr_parser(&rr_productions, &HashSet::new(), None);
    ...
    let sr_parser = generate_glr_parser(&sr_productions, &HashSet::new(), None);
...
fn test_unit_production_elimination() {
    ...
    let parser_elim = generate_glr_parser(&productions, &HashSet::new(), None);
