#![cfg(test)]
//! Consolidated tests for weight pushing algorithms.
//!
//! ## Sections:
//! 1. **Basic pushing tests** - from residuated_push.rs
//! 2. **State merging optimization tests** - from test_weight_push_optimization.rs
//!
//! ## The Missed Optimization Problem
//!
...
// =============================================================================
// SECTION 1: Basic pushing tests (from residuated_push.rs)
// =============================================================================
...
// =============================================================================
// SECTION 2: State merging optimization tests (from test_weight_push_optimization.rs)
// =============================================================================
...
fn test_optimal_merged_example() {
    use crate::precompute4::weighted_automata::dwa::DWAState;
