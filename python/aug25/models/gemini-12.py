...
class Model(GraphProvider):
    ...
    def get_mask(self) -> RangeSet:
        ...
        # Defer GSS merges by storing lists of GSSs.
        ...
        while depth_heap:
            ...
            while todo[depth]:
                ...
                gss_node: GSS = GSS.merge_many(gss_list) if len(gss_list) > 1 else gss_list[0]
                ...
                for (pop, llm_bv), dests in edges:
                    ...
                    for dest_idx, state_bv in dests:
                        # Optimized peek and filter using RangeSet intersection
                        peeked_rs = RangeSet.from_indices(popped.peek())
