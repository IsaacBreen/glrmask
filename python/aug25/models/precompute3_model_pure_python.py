...
class Model(GraphProvider):
    ...
    def from_json_string(s: str) -> 'Model':
        ...
        model.state = model.constraint_state.get_state_map()
    ...
    def commit(self, token_id: int):
        ...
        self.state = self.constraint_state.get_state_map()
    ...
    def get_mask(self) -> RangeSet:
        ...
        state_map = {sid: convert_rust_gss_to_python_gss(rust_gss) for sid, rust_gss in self.state.items()}
