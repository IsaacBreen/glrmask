...
class Model(GraphProvider):
    ...
    def from_json_string(s: str) -> 'Model':
        ...
        # Re-compute/narrow all state weights using a sophisticated propagation method.
        ...
        # Assign the computed, more precise weights.
        # If a weight already exists, we narrow it.
