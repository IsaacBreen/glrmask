...
RangeSet RangeSet::from_indices(const std::vector<unsigned long long>& indices) {
    RangeSet rs;
...
RangeSet RangeSet::from_ranges(const std::vector<std::pair<unsigned long long, unsigned long long>>& ranges) {
    RangeSet rs;
...
bool RangeSet::contains(unsigned long long v) const {
    return boost::icl::contains(m_set, v);
}

RangeSet RangeSet::union_with(const RangeSet& other) const {
    RangeSet res;
    res.m_set = m_set;
...
RangeSet RangeSet::intersection_with(const RangeSet& other) const {
    RangeSet res;
    res.m_set = m_set & other.m_set;
    return res;
}

RangeSet RangeSet::difference_with(const RangeSet& other) const {
    RangeSet res;
    res.m_set = m_set - other.m_set;
    return res;
}

bool RangeSet::is_empty() const {
    return m_set.empty();
}

std::vector<std::pair<unsigned long long, unsigned long long>> RangeSet::to_ranges() const {
...
std::vector<unsigned long long> RangeSet::to_indices() const {
...
std::string RangeSet::repr() const {
