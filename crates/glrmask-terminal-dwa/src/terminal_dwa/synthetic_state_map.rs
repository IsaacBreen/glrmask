...
#[derive(Debug, Clone)]
pub struct CertifiedFullToSynthesizedStateMap {
    /// Full raw lexer state -> synthesized raw lexer state.
    pub full_to_synthesized: Vec<u32>,
}

#[derive(Debug, Clone)]
pub struct SynthesizedTerminalExpressions {
    pub expressions: Vec<Expr>,
    pub changed_terminals: Vec<u32>,
}

pub struct MaterializedActiveTokenizer {
    pub tokenizer: Tokenizer,
    pub full_to_active: CertifiedFullToSynthesizedStateMap,
    pub build_ms: f64,
}
...
pub fn materialize_active_tokenizer(
    tokenizer: &Tokenizer,
    vocab: &Vocab,
...
pub fn profile_dispatch_component_activity(
    tokenizer: &Tokenizer,
    active_terminals: &[bool],
    branch_label: &str,
) {
...
pub fn inactive_dispatch_component_state_map(
    tokenizer: &Tokenizer,
    active_terminals: &[bool],
...
pub struct BoundedTerminalCandidateScanner {
...
impl BoundedTerminalCandidateScanner {
    ...
    pub fn is_candidate(&mut self, expression: &Expr) -> bool {
...
impl BoundedTerminalAnalysisCache {
    ...
    pub fn is_pathological_candidate(&mut self, expr: &Expr) -> bool {
        self.stats(expr).is_pathological_candidate()
    }

    pub fn has_reducible_repeat(&mut self, expr: &Expr) -> bool {
        self.stats(expr).count != 0
    }
}

pub fn debug_reducible_repeat_stats(
    expr: &Expr,
    max_token_len: usize,
...
pub fn is_pathological_bounded_terminal_candidate(
    expr: &Expr,
    max_token_len: usize,
) -> bool {
...
pub fn has_reducible_bounded_repeat(expr: &Expr, max_token_len: usize) -> bool {
...
pub fn estimated_synthesis_state_volume(expr: &Expr) -> u128 {
...
pub fn synthesize_terminal_expressions_for_horizon(
    expressions: &[Expr],
    max_token_len: usize,
...
pub fn synthesize_bounded_terminal_expressions(
    expressions: &[Expr],
    vocab: &Vocab,
    horizons: &VocabularyRepeatHorizonCache,
) -> SynthesizedTerminalExpressions {
...
pub fn certify_vocabulary_exact_state_candidates(
    full: &Tokenizer,
    synthesized: &Tokenizer,
    vocab: &Vocab,
    active_terminals: Option<&[bool]>,
...
pub fn certify_vocabulary_exact_state_map(
    full: &Tokenizer,
    synthesized: &Tokenizer,
    vocab: &Vocab,
    active_terminals: Option<&[bool]>,
...
pub fn certify_full_to_synthesized_state_map(
    full: &Tokenizer,
    synthesized: &Tokenizer,
    vocab: &Vocab,
    active_terminals: Option<&[bool]>,
