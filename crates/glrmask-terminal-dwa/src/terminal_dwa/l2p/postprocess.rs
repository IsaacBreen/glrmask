...
pub fn prune_unreachable_states(nwa: &mut NWA) -> bool {
...
pub fn max_structural_label_depth_to_final(nwa: &NWA) -> Option<usize> {
...
pub fn prune_non_coreachable_states(nwa: &mut NWA) -> bool {
    if nwa.states().is_empty() {
        return false;
    }
...
pub fn collapse_always_allowed(
    nwa: &mut NWA,
    always_allowed_by_label: &[Vec<TerminalID>],
    terminals_count: usize,
) -> bool {
...
pub fn apply_disallowed_follow_constraints(
    nwa: &mut NWA,
