...
pub struct RawRestrictedObservationResult {
    pub state_map: ManyToOneIdMap,
    pub raw_observation_ids: Vec<u32>,
    pub observation_representatives: Vec<u32>,
    pub label_ms: f64,
    pub refine_ms: f64,
...
pub fn hopcroft_refine_sparse_edges(
    initial_classes: &[u32],
    offsets: Vec<u32>,
    bytes: Vec<u8>,
    targets: Vec<u32>,
