...
pub mod max_length;
pub mod global_token_position;
pub mod nfa;
pub mod pipeline;
pub mod restricted_observation;
...
pub fn identity_state_map(num_states: usize) -> ManyToOneIdMap {
...
pub fn build_state_map_from_subset_representatives(
    states: &[usize],
