...
|---|---|---|
| `GLRMASK_DISABLE_FACTORED_ORDERED_OBJECT=1` | off | Disable factored ordered-object grammar entirely |
| `GLRMASK_DISABLE_FACTORED_CLOSED_OBJECT=1` | off | Disable for closed objects specifically |
