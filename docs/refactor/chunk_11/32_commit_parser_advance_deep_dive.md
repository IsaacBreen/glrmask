# Deep dive: runtime/commit/parser_advance.rs

This file documents `32_commit_parser_advance_deep_dive.md`'s target role after Chunk 11.  The focus is
template-DFA versus GLR-table stack advance.  It is intentionally more detailed than ordinary inline comments
because these notes are meant to guide the later all-at-once implementation
and compile-repair pass.

## What belongs here

- Code whose primary responsibility is template-DFA versus GLR-table stack advance.
