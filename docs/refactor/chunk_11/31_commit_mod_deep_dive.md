# Deep dive: runtime/commit/mod.rs

This file documents `31_commit_mod_deep_dive.md`'s target role after Chunk 11.  The focus is
the remaining Commit phase graph.  It is intentionally more detailed than ordinary inline comments
because these notes are meant to guide the later all-at-once implementation
and compile-repair pass.

## What belongs here

- Code whose primary responsibility is the remaining Commit phase graph.
