# Deep dive: runtime/mask/dense_acc.rs

This file documents `29_mask_dense_acc_deep_dive.md`'s target role after Chunk 11.  The focus is
dense internal-token accumulators.  It is intentionally more detailed than ordinary inline comments
because these notes are meant to guide the later all-at-once implementation
and compile-repair pass.

## What belongs here

- Code whose primary responsibility is dense internal-token accumulators.
