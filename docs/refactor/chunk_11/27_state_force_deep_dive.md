# Deep dive: runtime/state/force.rs

This file documents `27_state_force_deep_dive.md`'s target role after Chunk 11.  The focus is
derived forced-token inference.  It is intentionally more detailed than ordinary inline comments
because these notes are meant to guide the later all-at-once implementation
and compile-repair pass.

## What belongs here

- Code whose primary responsibility is derived forced-token inference.
