# Deep dive: runtime/state/inspect.rs

This file documents `26_state_inspect_deep_dive.md`'s target role after Chunk 11.  The focus is
read-only frontier observations.  It is intentionally more detailed than ordinary inline comments
because these notes are meant to guide the later all-at-once implementation
and compile-repair pass.

## What belongs here

- Code whose primary responsibility is read-only frontier observations.
