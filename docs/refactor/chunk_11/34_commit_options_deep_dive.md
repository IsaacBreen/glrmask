# Deep dive: runtime/commit/options.rs

This file documents `34_commit_options_deep_dive.md`'s target role after Chunk 11.  The focus is
environment controlled runtime switches.  It is intentionally more detailed than ordinary inline comments
because these notes are meant to guide the later all-at-once implementation
and compile-repair pass.

## What belongs here

- Code whose primary responsibility is environment controlled runtime switches.
