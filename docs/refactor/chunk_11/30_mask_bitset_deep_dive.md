# Deep dive: runtime/mask/bitset.rs

This file documents `30_mask_bitset_deep_dive.md`'s target role after Chunk 11.  The focus is
public packed mask bit operations.  It is intentionally more detailed than ordinary inline comments
because these notes are meant to guide the later all-at-once implementation
and compile-repair pass.

## What belongs here

- Code whose primary responsibility is public packed mask bit operations.
