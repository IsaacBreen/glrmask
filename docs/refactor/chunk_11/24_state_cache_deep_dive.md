# Deep dive: runtime/state/cache.rs

This file documents `24_state_cache_deep_dive.md`'s target role after Chunk 11.  The focus is
the mask cache and mask scratch boundary.  It is intentionally more detailed than ordinary inline comments
because these notes are meant to guide the later all-at-once implementation
and compile-repair pass.

## What belongs here

- Code whose primary responsibility is the mask cache and mask scratch boundary.
