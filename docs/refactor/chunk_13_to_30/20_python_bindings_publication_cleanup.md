# Chunk 20: Python bindings publication cleanup
...
- `bindings/python/python/README.md`
- `bindings/python/src/constraint.rs`
- `bindings/python/src/conversion.rs`
- `bindings/python/src/lib.rs`
- `bindings/python/src/module.rs`
- `bindings/python/src/state.rs`
- `bindings/python/src/state_lifetime.rs`
- `bindings/python/src/vocab.rs`
