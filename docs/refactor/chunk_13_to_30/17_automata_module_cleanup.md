# Chunk 17: Automata module cleanup
...
- `src/automata/README.md`
- `src/automata/lexer/ast.rs`
- `src/automata/lexer/compile.rs`
- `src/automata/lexer/determinize.rs`
- `src/automata/lexer/dfa.rs`
- `src/automata/lexer/lightweight/mod.rs`
- `src/automata/lexer/lightweight/nfa.rs`
- `src/automata/lexer/minimize.rs`
- `src/automata/lexer/mod.rs`
- `src/automata/lexer/nfa.rs`
- `src/automata/lexer/regex.rs`
- `src/automata/lexer/tokenizer.rs`
- `src/automata/mod.rs`
- `src/automata/unweighted/README.md`
- `src/automata/unweighted/determinize.rs`
- `src/automata/unweighted/dfa.rs`
- `src/automata/unweighted/minimize_acyclic.rs`
- `src/automata/unweighted/minimize_cyclic.rs`
- `src/automata/unweighted/mod.rs`
- `src/automata/unweighted/nfa.rs`
- `src/automata/unweighted/subtract.rs`
- `src/automata/weighted/README.md`
- `src/automata/weighted/determinize.rs`
- `src/automata/weighted/dwa.rs`
- `src/automata/weighted/minimize.rs`
- `src/automata/weighted/minimize_acyclic.rs`
