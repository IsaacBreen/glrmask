# Chunk 16: Leveled GSS and parser stack data structures
...
- `src/parser/gss/README.md`
- `src/parser/gss/mod.rs`
- `src/ds/stack_vecs/README.md`
- `src/ds/stack_vecs/arc_array_vec.rs`
- `src/ds/stack_vecs/dispatch.rs`
- `src/ds/stack_vecs/mod.rs`
- `src/ds/stack_vecs/stack_vec.rs`
- `src/ds/stack_vecs/vec_stack_vec.rs`
