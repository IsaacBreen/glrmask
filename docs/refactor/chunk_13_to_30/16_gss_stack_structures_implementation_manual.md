# Chunk 16 implementation manual: gss_stack_structures

## Scope

src/parser/gss + src/ds/stack_vecs

## Exact files to open first

1. `src/parser/gss/README.md`
2. `src/parser/gss/mod.rs`
3. `src/ds/stack_vecs/README.md`
4. `src/ds/stack_vecs/arc_array_vec.rs`
5. `src/ds/stack_vecs/dispatch.rs`
6. `src/ds/stack_vecs/mod.rs`
7. `src/ds/stack_vecs/stack_vec.rs`
8. `src/ds/stack_vecs/vec_stack_vec.rs`
