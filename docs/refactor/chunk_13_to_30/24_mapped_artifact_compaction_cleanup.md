# Chunk 24: Mapped artifact and compaction cleanup
...
- `src/compile/mapped_artifact/README.md`
- `src/compile/mapped_artifact/mod.rs`
- `src/compile/id_space.rs`
- `src/runtime/token_space/final_mask_mapping.rs`
