# Chunk 14 implementation manual: template_dfa_subsystem

## Scope

src/compile/template_dfa + src/runtime/template_dfa

## Exact files to open first

1. `src/compile/template_dfa/README.md`
2. `src/compile/template_dfa/mod.rs`
3. `src/runtime/template_dfa/README.md`
4. `src/runtime/template_dfa/advance.rs`
5. `src/runtime/template_dfa/mod.rs`
