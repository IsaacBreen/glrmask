# `accessors.rs` deep dive

## Summary

The file owns methods that expose artifact facts or create a fresh runtime state.  These methods are not cache builders and not mask evaluators.
