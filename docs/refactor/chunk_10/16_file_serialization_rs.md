# `serialization.rs` deep dive

## Summary

The file introduces explicit format metadata.  It is intentionally conservative: it adds a new envelope and keeps a fallback for old direct-bincode blobs.
